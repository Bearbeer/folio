...
module Portfolio
  ...
  class Entity < ActiveRecord::Base
    ...
    has_many :skills, class_name: 'Portfolio::Skill'
    has_many :careers, class_name: 'Portfolio::Career'
    has_many :educations, class_name: 'Portfolio::Education'
    has_many :projects, class_name: 'Portfolio::Project'
